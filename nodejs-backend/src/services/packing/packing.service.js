const { Packing } = require("./packing.class");
const createModel = require("./packing.model");
const hooks = require("./packing.hooks");
...
module.exports = function (app) {
  ...
  app.use("/packing", new Packing(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("packing");

  // Get the schema of the collections 
  app.get("/packingSchema", function (request, response) {
