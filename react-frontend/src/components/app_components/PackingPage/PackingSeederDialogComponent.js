...
import seederData from "./packing.seeder.json";
...
const PackingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PackingSeederDialogComponent);
