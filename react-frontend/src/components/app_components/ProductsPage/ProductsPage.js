...
const ProductsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("products")
            .find({ query: { $limit: 10000 , category : urlParams.singleCategoryId ,brand : urlParams.singleBrandId ,packing : urlParams.singlePackingId ,weight : urlParams.singleWeightId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
