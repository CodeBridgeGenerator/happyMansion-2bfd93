...
import seederData from "./weight.seeder.json";
...
const WeightSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WeightSeederDialogComponent);
